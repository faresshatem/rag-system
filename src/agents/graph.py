...
async def build_graph():
    ...
    # 2. Retrieval / Web Search / Verification / Synthesis use the real,
    #    production implementations (hybrid dense+sparse+RRF retrieval, live
    #    Tavily web search, LLM-based grading, and LLM-based cited synthesis).
    ...
    workflow.add_edge("Web_Search_Agent", "Verification_Agent")
