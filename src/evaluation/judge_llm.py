...
from src.evaluation.audit import log_llm_judge
...
class JudgeResult(BaseModel):
    ...
    relevance: float = Field(
        description="Score between 0 and 1 indicating whether the answer answers the user's question."
    )
...
"""
    ...
    def evaluate(
        ...
        # Change to use_local=False if your team uses Groq
